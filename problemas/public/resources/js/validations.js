validations ={//during, post, range of values
    ...
    'codigo': [/^[a-zA-Z0-9_]{1,2}$/,/^[a-zA-Z0-9_]{1,2}$/, 'Solo se acepta texto alfanumerico entre 1 y 2 caracteres.'],
    ...
    'text': [/^[a-zA-Z0-9 ñÑáéíóúÁÉÍÓÚ@.,()/_.-]{0,200}$/,/^[a-zA-Z0-9 ñÑáéíóúÁÉÍÓÚ@.,()/_.-]{0,200}$/, 'Solo se aceptan texto menor a 200 caracteres.'],
